...
Mais uma vez, o diagnóstico só é possível com o cruzamento dos dados do censo escolar e a base de dados do INEP. Esse filtro enumera a quantidade de escolas anexas que devem ser inspecionadas. Outro indicador interessante é verificar o número de salas declarado no censo escolar pela escola polo. Então, basta dividir o número total de alunos declarados no censo como matriculados na escola polo pelo número de salas de ensino disponíveis. É possível ainda a criação de um filtro para selecionar os resultados maiores que o limite máximo de alunos por turma estipulado pelo Conselho Estadual de Educação por modalidade de ensino (Instrução Normativa CEE nº 347/2023). A discrepância fica evidente.

Esse filtro permite direcionar os esforços das Promotorias com precisão, incrementando-se a eficiência da intervenção.  
